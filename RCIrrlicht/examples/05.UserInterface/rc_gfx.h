...
/*  Not in member list
void rc_applySpriteMassFromShapes(int spr_id)
{
    if(spr_id < 0 || spr_id >= rc_sprite.size())
		return;
    ...
    rc_sprite[spr_id].physics.body->ApplyMassFromShapes();
}
*/
...
/*
b2AABB rc_computeSpriteAABB(int spr_id)
{
    if(spr_id < 0 || spr_id >= rc_sprite.size())
		return;
